		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "FioriLibTitle",
									"targetURL": "#fiorilibappname-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fiorilibappname-display": {
								"semanticObject": "fiorilibappname",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fiorilibappname",
									"url": sap.ui.require.toUrl("fiorilibappname")
								}
							}
						}
					}
